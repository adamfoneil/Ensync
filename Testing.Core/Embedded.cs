...
{
	[TestMethod]
	public async Task UnexpectedUniqueDrop() => await TestEmbeddedAsync("Testing.Core.EmbeddedCases.UnexpectedUniqueDrop.zip",
	[
	...
	[TestMethod]
	public async Task ShouldRebuildFK() => await TestEmbeddedAsync("Testing.Core.EmbeddedCases.ShouldRebuildFK.zip",
	[
	...
	[TestMethod]
	public async Task RemoveImplicitFKDrops() => await TestEmbeddedAsync("Testing.Core.EmbeddedCases.RemoveImplicitFKDrops.zip",
	[
	...
	[TestMethod]
	public async Task ShouldAddConventionColumns() => await TestEmbeddedAsync("Testing.Core.EmbeddedCases.ShouldAddConventionColumns.zip",
	[        
